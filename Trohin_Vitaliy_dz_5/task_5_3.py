...
print(timeit("append_lst()", globals=globals(), number=1000))
...
print(timeit("extend_lst()", globals=globals(), number=1000))
print(timeit("extend_deque()", globals=globals(), number=1000))

# При применениии операций: append, pop и extend скорость равна, присутствуют небольшие погрешности.
...
# Операции со списком работают быстрее.
